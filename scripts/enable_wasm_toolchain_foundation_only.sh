...
# cabal build --project-file=cabal-wasm-foundation-only.project cardano-api-wasm-foundation-only --keep-going



wasm32-wasi-cabal build  --project-file=cabal-wasm-foundation-only.project cardano-api-wasm-foundation-only 
