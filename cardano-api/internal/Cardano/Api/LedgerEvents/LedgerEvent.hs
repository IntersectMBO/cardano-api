...
module Cardano.Api.LedgerEvents.LedgerEvent
  ...
  , PoolReapDetails(..)
  , convertRetiredPoolsMap ) where

import           Cardano.Api.Address
       ( StakeCredential, fromShelleyStakeCredential )
...
data AnyRatificationState =
  forall era. Ledger.Core.EraPParams era
  => AnyRatificationState (Ledger.RatifyState era)
...
convertRetiredPoolsMap =
  Map.mapKeys fromShelleyStakeCredential . fmap (Map.mapKeys StakePoolKeyHash)
