...
caseByronOrShelleyBasedEra ::
     () => a -> (ShelleyBasedEraConstraints era => ShelleyBasedEra era -> a) -> CardanoEra era -> a
caseByronOrShelleyBasedEra l r =
  \case
...
caseByronToAlonzoOrBabbageEraOnwards ::
  ...
  -> CardanoEra era
  -> a
caseByronToAlonzoOrBabbageEraOnwards l r =
  \case
...
caseShelleyEraOnlyOrAllegraEraOnwards ::
  ...
  -> ShelleyBasedEra era
  -> a
caseShelleyEraOnlyOrAllegraEraOnwards l r =
  \case
...
caseShelleyToAllegraOrMaryEraOnwards ::
  ...
  -> ShelleyBasedEra era
  -> a
caseShelleyToAllegraOrMaryEraOnwards l r =
  \case
...
caseShelleyToMaryOrAlonzoEraOnwards ::
  ...
  -> ShelleyBasedEra era
  -> a
caseShelleyToMaryOrAlonzoEraOnwards l r =
  \case
...
caseShelleyToAlonzoOrBabbageEraOnwards ::
  ...
  -> ShelleyBasedEra era
  -> a
caseShelleyToAlonzoOrBabbageEraOnwards l r =
  \case
...
caseShelleyToBabbageOrConwayEraOnwards ::
  ...
  -> ShelleyBasedEra era
  -> a
caseShelleyToBabbageOrConwayEraOnwards l r =
  \case
