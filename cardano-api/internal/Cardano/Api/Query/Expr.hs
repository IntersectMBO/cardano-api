...
module Cardano.Api.Query.Expr
  ...
  , queryDRepState
  , queryGovState
  , queryStakeVoteDelegatees ) where
...
queryChainBlockNo = queryExpr QueryChainBlockNo
...
queryChainPoint = queryExpr QueryChainPoint
...
queryCurrentEra = queryExpr QueryCurrentEra
...
queryEpoch sbe = queryExpr $ QueryInEra $ QueryInShelleyBasedEra sbe QueryEpoch
...
queryEraHistory = queryExpr QueryEraHistory
...
queryPoolDistribution era mPoolIds = do
  ...
  queryExpr
    ...
    $ QueryPoolDistribution mPoolIds
...
queryProtocolParameters
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (Ledger.PParams (ShelleyLedgerEra era))))
...
queryConstitutionHash
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       ...
       (Either
          EraMismatch
          (SafeHash (EraCrypto (ShelleyLedgerEra era)) L.AnchorData)))
...
queryProtocolParametersUpdate sbe =
  queryExpr
  $ QueryInEra
  $ QueryInShelleyBasedEra sbe QueryProtocolParametersUpdate
...
queryStakeDelegDeposits
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either Consensus.EraMismatch (Map StakeCredential L.Coin)))
...
queryStakeDistribution
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (Map (Hash StakePoolKey) Rational)))
...
querySystemStart = queryExpr QuerySystemStart
...
queryConstitution
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (L.Constitution (ShelleyLedgerEra era))))
...
queryGovState
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (L.GovState (ShelleyLedgerEra era))))
    ...
    (Either
       ...
       (Either
          ...
          (Map
             ...
             (L.DRepState L.StandardCrypto))))
queryDRepState era drepCreds = do
  let sbe = conwayEraOnwardsToShelleyBasedEra era
  queryExpr
    $ QueryInEra
    $ QueryInShelleyBasedEra sbe
    $ QueryDRepState drepCreds
...
queryDRepStakeDistribution
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (Map (L.DRep L.StandardCrypto) L.Coin)))
...
queryCommitteeMembersState
  ...
  -> LocalStateQueryExpr
    ...
    (Either
       UnsupportedNtcVersionError
       (Either EraMismatch (L.CommitteeMembersState L.StandardCrypto)))
...
queryAccountState cOnwards =
  queryExpr
  $ QueryInEra
  . QueryInShelleyBasedEra (conwayEraOnwardsToShelleyBasedEra cOnwards)
  $ QueryAccountState
