...
queryProtocolState sbe = queryExpr $ QueryInEra $ QueryInShelleyBasedEra sbe QueryProtocolState
...
queryStakePools sbe = queryExpr $ QueryInEra . QueryInShelleyBasedEra sbe $ QueryStakePools
...
queryDRepState ::
  ...
  -> LocalStateQueryExpr
       ...
       (Either
          ...
          (Either
             EraMismatch
             (Map (L.Credential L.DRepRole L.StandardCrypto) (L.DRepState L.StandardCrypto))))
