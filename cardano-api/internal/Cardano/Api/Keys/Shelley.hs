...
newtype instance Hash PaymentKey = PaymentKeyHash {unPaymentKeyHash :: Shelley.KeyHash Shelley.Payment StandardCrypto}
...
newtype instance Hash PaymentExtendedKey = PaymentExtendedKeyHash
...
newtype instance Hash StakeKey = StakeKeyHash {unStakeKeyHash :: Shelley.KeyHash Shelley.Staking StandardCrypto}
  deriving stock (Eq, Ord)
...
newtype instance Hash CommitteeHotKey = CommitteeHotKeyHash
...
newtype instance Hash CommitteeColdKey = CommitteeColdKeyHash
...
newtype instance Hash CommitteeColdExtendedKey = CommitteeColdExtendedKeyHash
...
newtype instance Hash CommitteeHotExtendedKey = CommitteeHotExtendedKeyHash
...
newtype instance Hash GenesisExtendedKey = GenesisExtendedKeyHash
...
newtype instance Hash GenesisDelegateKey = GenesisDelegateKeyHash
...
newtype instance Hash GenesisDelegateExtendedKey = GenesisDelegateExtendedKeyHash
...
newtype instance Hash GenesisUTxOKey = GenesisUTxOKeyHash {unGenesisUTxOKeyHash :: Shelley.KeyHash Shelley.Payment StandardCrypto}
  deriving stock (Eq, Ord)
...
newtype instance Hash StakePoolKey = StakePoolKeyHash {unStakePoolKeyHash :: Shelley.KeyHash Shelley.StakePool StandardCrypto}
  deriving stock (Eq, Ord)
...
newtype instance Hash DRepKey = DRepKeyHash {unDRepKeyHash :: Shelley.KeyHash Shelley.DRepRole StandardCrypto}
  deriving stock (Eq, Ord)
...
newtype instance Hash DRepExtendedKey = DRepExtendedKeyHash {unDRepExtendedKeyHash :: Shelley.KeyHash Shelley.DRepRole StandardCrypto}
  deriving stock (Eq, Ord)
  deriving (Show, IsString) via UsingRawBytesHex (Hash DRepKey)
  deriving (ToCBOR, FromCBOR) via UsingRawBytes (Hash DRepKey)
  deriving anyclass (SerialiseAsCBOR)
