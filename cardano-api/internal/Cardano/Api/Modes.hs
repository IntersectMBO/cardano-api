...
data ConsensusModeParams where
  CardanoModeParams :: Byron.EpochSlots -> ConsensusModeParams
...
type family ConsensusCryptoForBlock block where
  ...
  ConsensusCryptoForBlock (Consensus.ShelleyBlockHFC
                             (Consensus.TPraos StandardCrypto)
                             Consensus.StandardShelley) = Consensus.StandardShelley
...
toConsensusEraIndex ::
  ...
  => Consensus.CardanoBlock L.StandardCrypto ~ Consensus.HardForkBlock xs =>
       CardanoEra era -> Consensus.EraIndex xs
toConsensusEraIndex =
  \case
    ByronEra -> eraIndex0
...
fromConsensusEraIndex ::
     () => Consensus.EraIndex (Consensus.CardanoEras StandardCrypto) -> AnyCardanoEra
fromConsensusEraIndex =
  \case
    Consensus.EraIndex (Z (K ())) -> AnyCardanoEra ByronEra
    Consensus.EraIndex (S (Z (K ()))) -> AnyCardanoEra ShelleyEra
    Consensus.EraIndex (S (S (Z (K ())))) -> AnyCardanoEra AllegraEra
    Consensus.EraIndex (S (S (S (Z (K ()))))) -> AnyCardanoEra MaryEra
    Consensus.EraIndex (S (S (S (S (Z (K ())))))) -> AnyCardanoEra AlonzoEra
    Consensus.EraIndex (S (S (S (S (S (Z (K ()))))))) -> AnyCardanoEra BabbageEra
    Consensus.EraIndex (S (S (S (S (S (S (Z (K ())))))))) -> AnyCardanoEra ConwayEra
