...
fromShelleyGenesis :: Shelley.ShelleyGenesis Ledger.StandardCrypto
...
fromShelleyGenesis
  ...
  , protocolParamNetworkId =
      fromShelleyNetwork sgNetworkId (NetworkMagic sgNetworkMagic)
  , protocolParamActiveSlotsCoefficient =
      Ledger.unboundRational sgActiveSlotsCoeff
