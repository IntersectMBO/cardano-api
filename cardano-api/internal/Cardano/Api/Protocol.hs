...
instance IOLike m => Protocol m ByronBlockHFC where
  ...
  protocolInfo (ProtocolInfoArgsByron params) =
    (inject $ protocolInfoByron params, pure . map inject $ blockForgingByron params)
...
instance (CardanoHardForkConstraints StandardCrypto, IOLike m) =>
  ...
  protocolInfo (ProtocolInfoArgsCardano paramsCardano) = protocolInfoCardano paramsCardano
...
instance ( IOLike m
         , Consensus.LedgerSupportsProtocol
             (Consensus.ShelleyBlock (Consensus.TPraos StandardCrypto) (ShelleyEra StandardCrypto))
         ) =>
...
instance Consensus.LedgerSupportsProtocol
  ...
  protocolClientInfo ProtocolClientInfoArgsShelley = inject protocolClientInfoShelley
