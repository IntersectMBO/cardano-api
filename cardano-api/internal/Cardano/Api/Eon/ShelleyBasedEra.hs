...
forShelleyBasedEraInEonMaybe era yes = forShelleyBasedEraInEon era Nothing (Just . yes)
...
type ShelleyBasedEraConstraints era
  = ( C.HashAlgorithm (L.HASH (L.EraCrypto (ShelleyLedgerEra era)))
    ...
    , Consensus.ShelleyBlock (ConsensusProtocol era) (ShelleyLedgerEra era) ~ ConsensusBlockForEra
        era
...
data AnyShelleyBasedEra where
  AnyShelleyBasedEra :: Typeable era => ShelleyBasedEra era -> AnyShelleyBasedEra
...
instance FromJSON AnyShelleyBasedEra where
  parseJSON =
    withText "AnyShelleyBasedEra" $ \case
...
data InAnyShelleyBasedEra thing where
  InAnyShelleyBasedEra
    :: Typeable era => ShelleyBasedEra era -> thing era -> InAnyShelleyBasedEra thing

inAnyShelleyBasedEra :: () => ShelleyBasedEra era -> thing era -> InAnyShelleyBasedEra thing
inAnyShelleyBasedEra sbe a = shelleyBasedEraConstraints sbe $ InAnyShelleyBasedEra sbe a
