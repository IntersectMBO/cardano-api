...
instance Eon ShelleyToAllegraEra where
  -- This is a trivial existential type - replace with a 'AnyShelleyToAllegraEra' when it will be used anywhere
  type AnyEon ShelleyToAllegraEra = Some ShelleyToAllegraEra
