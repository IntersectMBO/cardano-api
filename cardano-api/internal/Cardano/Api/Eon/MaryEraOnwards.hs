...
instance EasyEvidence MaryEraOnwards era where
  easyEvidence era =
    case era of
      ByronEra   -> Nothing
      ShelleyEra -> Nothing
      AllegraEra -> Nothing
      MaryEra    -> Just MaryEraOnwardsMary
      AlonzoEra  -> Just MaryEraOnwardsAlonzo
      BabbageEra -> Just MaryEraOnwardsBabbage
      ConwayEra  -> Just MaryEraOnwardsConway
