...
instance Eon ShelleyToAlonzoEra where
  -- This is a trivial existential type - replace with a 'AnyShelleyToAlonzoEra' when it will be used anywhere
  type AnyEon ShelleyToAlonzoEra = Some ShelleyToAlonzoEra
