...
renderQueryConvenienceError (AcqFailure e) = "Acquiring failure: " <> textShow e
...
queryStateForBalancedTx era allTxIns certs =
  runExceptT $ do
  ...
  -- Query execution
    ...
    systemStart <- lift querySystemStart & onLeft (left . QceUnsupportedNtcVersion)
    stakePools <-
...
determineEra localNodeConnInfo = queryNodeLocalState localNodeConnInfo VolatileTip QueryCurrentEra
