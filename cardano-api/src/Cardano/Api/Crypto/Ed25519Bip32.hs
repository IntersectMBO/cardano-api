...
instance DSIGNAlgorithm Ed25519Bip32DSIGN where
  ...
  deriveVerKeyDSIGN (SignKeyEd25519Bip32DSIGN sk) = VerKeyEd25519Bip32DSIGN $ CC.toXPub sk
    --
    -- Core algorithm operations
    --
  type Signable Ed25519Bip32DSIGN = SignableRepresentation
  signDSIGN () a (SignKeyEd25519Bip32DSIGN sk) =
    SigEd25519Bip32DSIGN $ CC.sign (mempty :: ScrubbedBytes) sk (getSignableRepresentation a)
  ...
  genKeyDSIGN seed =
    SignKeyEd25519Bip32DSIGN
      $ CC.generateNew (getSeedBytes seed) (mempty :: ScrubbedBytes) (mempty :: ScrubbedBytes)
    --
  ...
  rawDeserialiseVerKeyDSIGN = either (const Nothing) (Just . VerKeyEd25519Bip32DSIGN) . CC.xpub
  rawDeserialiseSignKeyDSIGN = fmap SignKeyEd25519Bip32DSIGN . xPrvFromBytes
  rawDeserialiseSigDSIGN = either (const Nothing) (Just . SigEd25519Bip32DSIGN) . CC.xsignature
