...
--
-- The second 'TxInsReference' constructor parameter stores actual resolved datums. When any outputs of refrenced
-- 'TxIns' store only datum hash, the only way to use them in the script is to provide a resolved datum here.
