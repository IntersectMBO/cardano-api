...
module Test.Golden.ErrorsSpec
  ...
  , test_TxMetadataRangeError ) where
...
stakePoolVerKey1 =
  getVerificationKey
  $ deterministicSigningKey AsStakePoolKey (Crypto.mkSeedFromBytes seed1)

stakePoolVerKey2 :: VerificationKey StakePoolKey
stakePoolVerKey2 =
  getVerificationKey
  $ deterministicSigningKey AsStakePoolKey (Crypto.mkSeedFromBytes seed2)

paymentVerKey1 :: VerificationKey PaymentKey
paymentVerKey1 =
  getVerificationKey
  $ deterministicSigningKey AsPaymentKey (Crypto.mkSeedFromBytes seed1)
...
txid1 =
  ...
  $ deserialiseFromRawBytesHex
    AsTxId
    "210c0a4bb6391baf606843e67863d1474cc462374ab12c42d55f78a0b55b56e0"
...
scriptDataHash1 =
  fromJust
  $ hush
  $ deserialiseFromCBOR AsHashableScriptData
  $ serialiseToCBOR scriptData1
...
test_JsonDecodeError =
  testAllErrorMessages @JsonDecodeError [ JsonDecodeError string ]
...
test_LeadershipError =
  testAllErrorMessages_
    ...
    , ( "LeaderErrDecodeProtocolStateFailure"
      , LeaderErrDecodeProtocolStateFailure
          ( lazyBytestring, CBOR.DecoderErrorVoid ) )
    ...
    , ( "LeaderErrStakeDistribUnstable"
      , LeaderErrStakeDistribUnstable 1 2 3 4 )
...
test_ProtocolParametersError =
  testAllErrorMessages_
    ...
    [ ( "PParamsErrorMissingMinUTxoValue"
      , PParamsErrorMissingMinUTxoValue (AnyCardanoEra ConwayEra) )
...
test_ScriptDataJsonBytesError =
  testAllErrorMessages
    ...
    [ ScriptDataJsonBytesErrorValue
      $ ScriptDataJsonSchemaError Aeson.Null ScriptDataJsonNullNotAllowed
...
test_ScriptExecutionError =
  testAllErrorMessages_
    ...
    , ( "ScriptErrorMissingCostModel"
      , ScriptErrorMissingCostModel Plutus.PlutusV2 )
    , ( "ScriptErrorTranslationError"
      , ScriptErrorTranslationError testPastHorizonValue ) ]
...
testPastHorizonValue
  :: Ledger.AlonzoContextError (Ledger.AlonzoEra StandardCrypto)
...
test_TransactionValidityError =
  testAllErrorMessages_
    ...
    [ ( "TransactionValidityCostModelError"
      , TransactionValidityCostModelError
          (Map.fromList
             [ ( AnyPlutusScriptVersion PlutusScriptV2, costModel ) ])
          string ) ]
...
test_TxBodyError =
  testAllErrorMessages_
    ...
    , ( "TxBodyMetadataError"
      , TxBodyMetadataError [ ( 1, TxMetadataBytesTooLong 2 ) ] )
...
test_TxBodyErrorAutoBalance =
  testAllErrorMessages_
    ...
    , ( "TxBodyScriptExecutionError"
      , TxBodyScriptExecutionError
          [ ( ScriptWitnessIndexTxIn 1, ScriptErrorExecutionUnitsOverflow ) ] )
    ...
    , ( "TxBodyErrorAdaBalanceTooSmall"
      , TxBodyErrorAdaBalanceTooSmall txOutInAnyEra1 0 1 )
...
testAllErrorMessages
  :: forall a. ( HasCallStack, Data a, Error a ) => [ a ] -> TestTree
