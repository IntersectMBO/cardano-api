...
import Cardano.Ledger.Keys (GenDelegPair(..), Hash, KeyHash(..), KeyRole(..), VerKeyVRF)
  ...
  ShelleyGenesis
    ...
    , sgProtocolParams =
        emptyPParams
          ...
          & ppMaxBBSizeL .~ 65535
          & ppMaxBHSizeL .~ 65535
    , sgGenDelegs = Map.fromList [(genesisVerKeyHash, GenDelegPair delegVerKeyHash delegVrfKeyHash)]
  ...
  -- hash of the delegators verification key
    ...
    initialFundedAddress = Addr Testnet paymentCredential (StakeRefBase stakingCredential)
      where
        ...
        stakingCredential =
          KeyHashObj $ KeyHash "e37a65ea2f9bcefb645de4312cf13d8ac12ae61cf242a9aa2973c9ee"
    initialFunds :: Coin
