module Test.Cardano.Api.Typed.Ord ( tests ) where
...
ord_distributive :: ( Show a, Ord a, Ord b ) => H.Gen a -> (a -> b) -> Property
ord_distributive gen to = H.property $ do
  x <- H.forAll gen
  y <- H.forAll gen
  compare x y === compare (to x) (to y)

prop_ord_distributive_TxId :: Property
prop_ord_distributive_TxId = ord_distributive genTxId toShelleyTxId

prop_ord_distributive_TxIn :: Property
prop_ord_distributive_TxIn = ord_distributive genTxIn toShelleyTxIn
...
prop_ord_distributive_Address =
  ...
  where
    ...
    toAddressInAnyEra =
      anyAddressInShelleyBasedEra ShelleyBasedEraShelley . toAddressAny
...
tests =
  testGroup
    ...
    , testProperty
        "ord distributive StakeAddress"
        prop_ord_distributive_StakeAddress
    , testProperty
        "ord distributive TxMetadata"
        prop_ord_distributive_TxMetadata
    , testProperty
        "ord distributive ScriptData"
        prop_ord_distributive_ScriptData ]
