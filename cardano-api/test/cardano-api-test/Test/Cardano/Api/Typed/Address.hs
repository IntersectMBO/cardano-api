...
module Test.Cardano.Api.Typed.Address ( tests ) where
...
import           Test.Gen.Cardano.Api.Typed
       ( genAddressByron, genAddressShelley )
...
tests =
  testGroup
    ...
    , testProperty
        "roundtrip byron address JSON"
        prop_roundtrip_byron_address_JSON
    , testProperty
        "roundtrip shelley address JSON"
