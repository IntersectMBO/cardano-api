...
module Test.Cardano.Api.Typed.Envelope ( tests ) where
...
roundtrip_VerificationKey_envelope
  :: () => HasTypeProxy keyrole => Key keyrole => AsType keyrole -> Property
...
tests =
  testGroup
    ...
    [ testProperty
        "roundtrip ByronVerificationKey envelope"
        prop_roundtrip_ByronVerificationKey_envelope
    , testProperty
        "roundtrip ByronSigningKey envelope"
        prop_roundtrip_ByronSigningKey_envelope
    , testProperty
        "roundtrip PaymentVerificationKey envelope"
        prop_roundtrip_PaymentVerificationKey_envelope
    , testProperty
        "roundtrip PaymentSigningKey envelope"
        prop_roundtrip_PaymentSigningKey_envelope
    , testProperty
        "roundtrip StakeVerificationKey envelope"
        prop_roundtrip_StakeVerificationKey_envelope
    , testProperty
        "roundtrip StakeSigningKey envelope"
        prop_roundtrip_StakeSigningKey_envelope
    , testProperty
        "roundtrip StakePoolVerificationKey envelope"
        prop_roundtrip_StakePoolVerificationKey_envelope
    , testProperty
        "roundtrip StakePoolSigningKey envelope"
        prop_roundtrip_StakePoolSigningKey_envelope
    , testProperty
        "roundtrip GenesisVerificationKey envelope"
        prop_roundtrip_GenesisVerificationKey_envelope
    , testProperty
        "roundtrip GenesisSigningKey envelope"
        prop_roundtrip_GenesisSigningKey_envelope
    , testProperty
        "roundtrip GenesisDelegateVerificationKey envelope"
        prop_roundtrip_GenesisDelegateVerificationKey_envelope
    , testProperty
        "roundtrip GenesisDelegateSigningKey envelope"
        prop_roundtrip_GenesisDelegateSigningKey_envelope
    , testProperty
        "roundtrip KesVerificationKey envelope"
        prop_roundtrip_KesVerificationKey_envelope
    , testProperty
        "roundtrip KesSigningKey envelope"
        prop_roundtrip_KesSigningKey_envelope
    , testProperty
        "roundtrip VrfVerificationKey envelope"
        prop_roundtrip_VrfVerificationKey_envelope
    , testProperty
        "roundtrip VrfSigningKey envelope"
