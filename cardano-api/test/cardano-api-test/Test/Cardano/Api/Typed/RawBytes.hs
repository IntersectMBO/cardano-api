...
module Test.Cardano.Api.Typed.RawBytes ( tests ) where
...
prop_roundtrip_script_hash_raw = roundtrip_raw_bytes AsScriptHash genScriptHash
...
roundtrip_raw_bytes
  :: ( SerialiseAsRawBytes a, Eq a, Show a ) => AsType a -> H.Gen a -> Property
roundtrip_raw_bytes asType g = H.property $ do
  v <- H.forAll g
...
tests =
  testGroup
    ...
    [ testProperty
        "roundtrip shelley address raw"
        prop_roundtrip_shelley_address_raw
    , testProperty
        "roundtrip byron address raw"
        prop_roundtrip_byron_address_raw
    , testProperty
        "roundtrip stake address raw"
        prop_roundtrip_stake_address_raw
    , testProperty "roundtrip script hash raw" prop_roundtrip_script_hash_raw
    , testProperty
        "roundtrip verification ByronKey hash raw"
        prop_roundtrip_verification_ByronKey_hash_raw
    , testProperty
        "roundtrip verification PaymentKey hash raw"
        prop_roundtrip_verification_PaymentKey_hash_raw
    , testProperty
        "roundtrip verification StakeKey hash raw"
        prop_roundtrip_verification_StakeKey_hash_raw
    , testProperty
        "roundtrip verification StakePoolKey hash raw"
        prop_roundtrip_verification_StakePoolKey_hash_raw
    , testProperty
        "roundtrip verification GenesisKey hash raw"
        prop_roundtrip_verification_GenesisKey_hash_raw
    , testProperty
        "roundtrip verification GenesisDelegateKey hash raw"
        prop_roundtrip_verification_GenesisDelegateKey_hash_raw
    , testProperty
        "roundtrip verification KesKey hash raw"
        prop_roundtrip_verification_KesKey_hash_raw
    , testProperty
        "roundtrip verification VrfKey hash raw"
        prop_roundtrip_verification_VrfKey_hash_raw
    , testProperty
        "roundtrip verification GenesisUTxOKey hash raw"
        prop_roundtrip_verification_GenesisUTxOKey_hash_raw ]
