...
- 01-node-access-types.md (done) - the original snapshot design; its "Status: as built" section recorded the deferral this plan now pays off.
...
The field is implemented as a helper over the `mempool` capability field added by piece 10 phase 1 (see [plan-mempool-phases.md](plan-mempool-phases.md)).
