...
-- 'RelativeTime' to prove the millisecond conversion is exact (floored, not
-- rounded, and never routed through 'Double'). The second era is last and
-- carries a real 'History.EraEnd' bound, but its end must still come out
-- unset.
