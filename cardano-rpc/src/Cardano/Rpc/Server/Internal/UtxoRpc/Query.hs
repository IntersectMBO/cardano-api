...
readGenesisMethod _req = throwIO GrpcUnimplemented

readEraSummaryMethod
  :: MonadRpc e m
  => Proto UtxoRpc.ReadEraSummaryRequest
  -> m (Proto UtxoRpc.ReadEraSummaryResponse)
readEraSummaryMethod _req = throwIO GrpcUnimplemented

readTxMethod
  :: MonadRpc e m
  => Proto UtxoRpc.ReadTxRequest
  -> m (Proto UtxoRpc.ReadTxResponse)
readTxMethod _req = throwIO GrpcUnimplemented
...
readDataMethod
  :: MonadRpc e m
  => Proto UtxoRpc.ReadDataRequest
  -> m (Proto UtxoRpc.ReadDataResponse)
readDataMethod _req = throwIO GrpcUnimplemented

searchUtxosMethod
  :: MonadRpc e m
  => Proto UtxoRpc.SearchUtxosRequest
  -> m (Proto UtxoRpc.SearchUtxosResponse)
searchUtxosMethod _req = throwIO GrpcUnimplemented
