...
Multiple kinds can be specified (comma-separated). Kinds marked **yes** in the
"Changelog" column appear in the rendered changelog; others are recorded but hidden.

| Kind | Changelog | When to use |
|------|-----------|-------------|
...
| `compatible` | yes | Changed API in a backwards-compatible way (e.g., added a field) |
