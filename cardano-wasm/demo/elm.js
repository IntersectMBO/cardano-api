				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('cardano-wasm wallet demo')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('✓ the cardano-wasm engine loaded successfully in your browser.')
								])),
							A2(
							$elm$html$Html$p,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('The wallet application will appear here as it is built up in subsequent changes.')
								]))
						]))
				])),
			A2(
