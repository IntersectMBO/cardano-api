...
import Cardano.Wasm.Internal.JavaScript.GRPCTypes (JSGRPCClient, JSUtxoFilter, JSUtxos)
...
getUtxosImpl
  ...
  -> JSUtxoFilter
  -> IO JSUtxos
getUtxosImpl getUtxosJsFunc (GrpcObject client) = getUtxosJsFunc client
