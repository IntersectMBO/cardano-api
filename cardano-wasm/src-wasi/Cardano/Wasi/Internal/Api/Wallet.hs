...
getAddressBech32 walletCStr =
  newCString =<< (Wallet.getAddressBech32 <$> fromCJSON False "WalletObject" walletCStr)

getBech32ForVerificationKey :: WalletObjectJSON -> IO CString
getBech32ForVerificationKey walletCStr =
  newCString =<< Wallet.getBech32ForVerificationKeyImpl <$> fromCJSON False "WalletObject" walletCStr

getBech32ForSigningKey :: WalletObjectJSON -> IO CString
getBech32ForSigningKey walletCStr =
  newCString =<< Wallet.getBech32ForSigningKeyImpl <$> fromCJSON False "WalletObject" walletCStr

getBase16ForVerificationKeyHash :: WalletObjectJSON -> IO CString
getBase16ForVerificationKeyHash walletCStr =
  newCString
    =<< Wallet.getBase16ForVerificationKeyHashImpl <$> fromCJSON False "WalletObject" walletCStr
